...
t_val_v2 = np.linspace(1800, 2800, 1001)
plt.plot(t_val_v2[0:600], Ycm(t_val)[0:600])
plt.tick_params(axis='both', which='major', labelsize=13)
plt.xlabel('Time (years)',fontsize = 14);
plt.ylabel('Cumulative emissions (ppm)',fontsize = 14);
plt.grid(linestyle=':')
...
Cc_values = np.linspace(0, 1500, 201)
plt.plot(Cc_values, [Bioloss(val) for val in Cc_values])
plt.tick_params(axis='both', which='major', labelsize=13)
plt.xlabel('Cumulative anthropogenic emissions (ppm)',fontsize = 14);
plt.ylabel('Percentage vegetation carbon loss',fontsize = 14);
plt.grid(linestyle=':')
...
Cc_values = np.linspace(0, 1500, 201)
plt.plot(Cc_values, [BioCloss(val) for val in Cc_values])
plt.tick_params(axis='both', which='major', labelsize=13)
plt.xlabel('Cumulative anthropogenic emissions (ppm)',fontsize = 14);
plt.ylabel('Vegetation carbon loss (ppm)',fontsize = 14);
plt.grid(linestyle=':')
...
t_val_v2 = np.linspace(1800, 2800, 1001)
plt.plot(t_val_v2[0:600], Cvegoptlow(t_val)[0:600])
plt.tick_params(axis='both', which='major', labelsize=13)
plt.xlabel('Time (years)',fontsize = 14);
plt.ylabel('Percentage vegetation carbon loss',fontsize = 14);
plt.grid(linestyle=':')
...
t_val_v2 = np.linspace(1800, 2800, 1001)
plt.plot(t_val_v2[0:600], VCvegoptlow(t_val)[0:600])
plt.tick_params(axis='both', which='major', labelsize=13)
plt.xlabel('Time (years)',fontsize = 14);
plt.ylabel('Vegetation carbon loss (ppm)',fontsize = 14);
plt.grid(linestyle=':')
...
Tvmid = Tv - 286.36137145728475
Cvmid = Cv - 268.9431491140356
...
## plot from 1800 to 2400 in absolute Kelvin
...
## plot from 1800 to 2400 in absolute Celsius
...
## plot of total carbon concentration from 1800 to 2400
tv2 = np.linspace(1800, 2800, 100000)
plt.figure(figsize=(10, 5))
#plt.plot(tv, Tvmid)
plt.plot(tv2[10000:29999], Ct[10000:29999])
plt.tick_params(axis='both', which='major', labelsize=18)
plt.xlabel('Time (year)',fontsize = 18);
plt.ylabel('Carbon concentration (ppm)',fontsize = 18);
plt.grid(linestyle=':')
...
## plotting different carbon fluxes 


# plot of h function (vegetation growth coefficient)
...
# vectorizing the different functions for plotting

#vegfluxdyn(286.5,269,0)

vegfluxdyn_vectorized = np.vectorize(vegfluxdyn)
vegfluxdyn_values = vegfluxdyn_vectorized(Tv, Cv, tv) 
...
# carbon stock in the atmosphere


vegfluxdyn_values
vegcum = np.arange(100000) * 1.0
#np.min(Ca)
...
# Compute the area using the composite trapezoidal rule.
area = trapz(y, dx=1000/100000)
print("area =", area)

# Compute the area using the composite Simpson's rule.
area = simps(y, dx=1000/100000)
print("area =", area)
np.sum(y)*0.01
...
resultstr = np.str(result)

amplitr = np.str(np.max(data) - np.min(data))
